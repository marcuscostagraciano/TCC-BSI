...
NUM_REGISTROS: Final[int] = 2 * 10**9
...
sttime = perf_counter()
get_amplitude_using_C_minMax_result = get_amplitude_using_C_minMax(ARRAY_NUMEROS)
edtime = perf_counter()
print(f"get_amplitude_using_C_minMax timing: {edtime - sttime:.5f}s")
# print(f"get_amplitude_using_C_minMax result: {get_amplitude_using_C_minMax_result}")
...
sttime = perf_counter()
get_max_using_c_result = get_max_using_c(ARRAY_NUMEROS)
edtime = perf_counter()
print(f"get_max_using_c timing: {edtime - sttime:.5f}s")
# print(f"get_max_using_c result: {get_max_using_c_result}")

sttime = perf_counter()
max_result = np.max(ARRAY_NUMEROS)
edtime = perf_counter()
print(f"np.max timing: {edtime - sttime:.5f}s")
# print(f"np.max result: {max_result}\n")
...
sttime = perf_counter()
get_min_using_c_result = get_min_using_c(ARRAY_NUMEROS)
edtime = perf_counter()
print(f"get_min_using_c timing: {edtime - sttime:.5f}s")
# print(f"get_min_using_c result: {get_min_using_c_result}")

sttime = perf_counter()
min_result = np.min(ARRAY_NUMEROS)
edtime = perf_counter()
print(f"np.min timing: {edtime - sttime:.5f}s")
# print(f"np.min result: {min_result}\n")
...
# print(f"{bool(cy_variance_result == np_var_result) = }")
